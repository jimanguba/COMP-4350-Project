...
describe('ReviewForm', () => {
  ...
  it('submits a review with valid data', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('Review Title'), { target: { value: 'Great Book' } });
    fireEvent.change(screen.getByPlaceholderText('Enter your review'), { target: { value: 'This is a fantastic read!' } });
